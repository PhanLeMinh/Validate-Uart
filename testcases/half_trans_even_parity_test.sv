class half_trans_even_parity_test extends uart_base_test;
    `uvm_component_utils(half_trans_even_parity_test)

    uart_sequence uart_seq;
    uart_configuration cfg;

    function new(string name="half_trans_even_parity_test",uvm_component parent);
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        if(!cfg.randomize() with {parity == uart_configuration::EVEN; direction == uart_configuration::TRANS;})
