class half_rcv_2_stop_bit_test extends uart_base_test;
    `uvm_component_utils(half_rcv_2_stop_bit_test)

    uart_sequence rhs_seq;
    uart_configuration uart_cfg;

    function new(string name = "half_rcv_2_stop_bit_test", uvm_component parent);
