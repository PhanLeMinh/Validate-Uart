class half_trans_2_stop_bit_test extends uart_base_test;
    `uvm_component_utils(half_trans_2_stop_bit_test)

    uart_sequence lhs_seq;
    uart_configuration uart_cfg;

    function new(string name = "half_trans_2_stop_bit_test", uvm_component parent);
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        if(!uart_cfg.randomize() with {num_of_stop_bit == 2; direction == uart_configuration::TRANS;})
