class half_trans_none_parity_test extends uart_base_test;
    `uvm_component_utils(half_trans_none_parity_test)

    uart_sequence uart_seq;
    uart_configuration cfg;

    function new(string name="half_trans_none_parity_test",uvm_component parent);
